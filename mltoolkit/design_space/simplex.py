"""Simplex sampling for compositional design spaces."""
...
def sample_sobol_simplex(n_dims, k_nonzero, n_samples, material_constraints=None,
                         seed=42, oversample=False, oversample_factor=3.0,
    ...
    k_nonzero : int
        Number of non-zero dimensions per sample.
    n_samples : int
        Total number of samples to generate.
    material_constraints : dict or None
        Per-dimension constraints as {dim_idx: (min_val, max_val)}.
    seed : int, default=42
        Random seed for Sobol scrambling.
    oversample : bool, default=False
        If True, generate extra samples and filter.
    oversample_factor : float, default=3.0
        Factor for oversampling.
    enforce_order_2 : bool, default=False
        Round sample counts to powers of 2 for optimal Sobol properties.
    transformation : str, default='exponential'
        'exponential' or 'sort'.

    Returns
    -------
    samples : np.ndarray of shape (n_generated, n_dims)
    labels : np.ndarray of shape (n_generated,)
...
def sample_random_simplex(n_dims, k_nonzero, n_samples, material_constraints=None,
                          seed=42, transformation='exponential'):
